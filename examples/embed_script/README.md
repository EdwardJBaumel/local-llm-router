# Embed local-llm-router in your script

Shows the smallest useful embed: import routing, call Ollama, print tier + model + answer.

Use this pattern in **your own project repo** (portfolio site, SaaS side project, etc.). local-llm-router stays a dependency; your product name and repo stay yours.

## Run

From the `local_llm_router` repo root:
...
1. `pip install local-llm-router[ollama]` (or editable install from this repo)
